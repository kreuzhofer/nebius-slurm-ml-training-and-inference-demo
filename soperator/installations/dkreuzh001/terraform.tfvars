...
filestore_jail = {
  existing = {
    id = "computefilesystem-e00y7c1j8kwmytna3k"
  }
}
...
filestore_jail_submounts = [{
  ...
  mount_path = "/mnt/data"
  existing = {
    id = "computefilesystem-e00aexf30s4dnz12rs"
  }
}]
...
slurm_login_ssh_root_public_keys = [
  "ssh-rsa  daniel@MacBook-Pro.local",
]
...
# ---
backups_password = "VzfP//7lnrzeYPESAosPeFnYr1YoDhGygJwoOQcM1hc="
